 ...
 *
 * <p>Implements {@link Iterator} for convenience.
 *
 * <p>The inherited {@code hasNext} method returns {@code true} if more deals are available, which
 * is usually true except if say a tournament dealer, which uses random or prebuilt deals of a
 * specific quantity.
 *
 * <p>The inherited {@code next} method is a short cut for {@code generateDeal(4)} assuming a
 * 4-player card game.
 */
